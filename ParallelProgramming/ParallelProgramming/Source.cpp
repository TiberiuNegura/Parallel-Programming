...
int main(int argc, char** argv)
{
	...
	//Sorting::MPI_Sort(numbers, rank, size, Sorting::BubbleSort);
	//Sorting::MPI_OddEven(numbers, rank, size);
	//Sorting::MPI_RankingSort(numbers, rank, size);
	Sorting::MPI_ShellSort(numbers, rank, size);
